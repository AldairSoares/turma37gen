...
public class Carro {
	...
	// sobrecarga de construtor -  a sobrecarga é quando tem métodos 
	// com nomes iguais, 
	// mas com atribuições diferentes no parêntese, 
	// e até mesmo um sem atribuição declarada dentro do parêntese.
